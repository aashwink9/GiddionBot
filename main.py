...
def allcommands(com):
    if com == "greeting":
        intro_mssg = "Hi I'm Giddion, Aashwin's proud creation. Nice to meet you! I can crack jokes, or generate a " \
                     "random number for you. Simply type 'crack jokes' if you want me to crack jokes, or " \
